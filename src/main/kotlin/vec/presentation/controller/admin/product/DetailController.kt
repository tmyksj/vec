...
import vec.presentation.form.admin.product.DetailForm
...
class DetailController(
    ...
    @RequestMapping(method = [RequestMethod.GET], path = ["/admin/product/{id}"])
    fun get(
        ...
        return Mono.defer {
            ...
            renderingComponent.view("layout/default")
                ...
                .modelAttribute("template", "template/admin/product/detail")
